...
public class DatabaseFileOperations {
    ...
    public String addStudentToFile(Student student) {
    ...
    public String showStudentsFromFile() {
        StringBuilder result = new StringBuilder();
    ...
    public String saveStudentToDatabase(Student student) {
        StringBuilder result = new StringBuilder();
    ...
    public String updateStudentInDatabase(int id, String newName, int newYear) {
        StringBuilder result = new StringBuilder();
    ...
    public String addTeacherToFile(Teacher teacher) {
        StringBuilder result = new StringBuilder();
        try {
    ...
    public String showTeachersFromFile() {
        StringBuilder result = new StringBuilder();
    ...
    public String saveTeacherToDatabase(Teacher teacher) {
        StringBuilder result = new StringBuilder();
    ...
    public String readTeachersFromDatabase() {
        StringBuilder result = new StringBuilder();
    ...
    public String updateTeacherInDatabase(int id, String newName, int newExperience) {
        StringBuilder result = new StringBuilder();
    ...
    public String deleteTeacherFromDatabase(int id) {
        StringBuilder result = new StringBuilder();
